...
class TTSEngine(TTSInterface):
    ...
    def __init__(self, api_key, region, voice, pitch=0, rate=1.0, style="general"):
        """
        ...
        style: str
            the speaking style (emotion). Default is "general"
        """
        ...
        # Initialize pitch, rate, and style
        self.pitch = pitch
        self.rate = rate
        self.style = style
    ...
    def __speak_with_audio_config(
        ...
        # Wrap the text with SSML to adjust pitch, rate, and style
        # Note: mstts namespace is required for express-as
        ssml_text = f"""
